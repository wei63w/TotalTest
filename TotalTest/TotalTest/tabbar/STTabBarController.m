...
- (void)initializeTabBarController{
    //主页
//    WYCMainViewController *home = [[WYCMainViewController alloc] init];
    
    UIStoryboard *mainStoryBoard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
    WYCMainViewController *mainVc = [mainStoryBoard instantiateInitialViewController];
    
    
    [self addChildViewController:mainVc title:@"主页" image:@"tab_icon1_normal.png" selectedImage:@"tab_icon1_selcet.png"];
    
    //中心
    WYCSecondViewController *rVC = [[WYCSecondViewController alloc] init];
    [self addChildViewController:rVC title:@"中心" image:@"tab_icon2_normal.png" selectedImage:@"tab_icon2_selcet.png"];
    
    //我的
    WYCThirdViewController *userVC = [[WYCThirdViewController alloc] init];
